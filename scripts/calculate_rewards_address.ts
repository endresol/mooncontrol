...
const main = async () => {
  ...
  console.log(`Calculating rewards for user: ${address}`);
  ...
  console.log(`Rewards for ${address}:`, userRewards);
  console.log("Rewards Summary:", rewardsSummary);

  // Insert rewards into the rewards table
  // NO insert
  // await insertRewardSummary(address, rewardsSummary, fromMonth, toMonth);
